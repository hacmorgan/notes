...
#+end_src
* regex
** Convert enums and other types from their ~repr()~ form to native python
This strips multiple occurrences of angle bracketed types back to their raw type name, as you would use to instantiate them directly
#+begin_src regex
